...
interface SearchComponent : KoinComponent {
...
class DefaultSearchComponent(
    ...
    override val state: MutableValue<SearchComponent.State> = MutableValue(
        stateKeeper.consume(key = "SEARCH_COMP_STATE_${stateKey}") ?: SearchComponent.State(
            sourceId = sourceId,
            query = initialQuery
        )
    )
